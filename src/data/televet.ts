...
export const mockVets: TeleVet[] = [
  ...
  },
  {
    ...
    experienceYears: 6,
    experiences: [
      { years: '2022-2026', description: 'ผู้เชี่ยวชาญด้านผิวหนังและภูมิแพ้ Pawmely สาขาทองหล่อ' },
  ...
  },
  {
    ...
    clinic: 'Pawmely สาขาอารีย์',
    experienceYears: 10,
    experiences: [
      { years: '2020-2026', description: 'ดูแลสัตว์เลี้ยงเล็กเฉพาะทาง Pawmely สาขาอารีย์ ทั้งกระต่าย แฮมสเตอร์ และนก' },
  ...
  },
  {
    ...
    experienceYears: 7,
    experiences: [
      { years: '2022-2026', description: 'หัวหน้าคลินิกจักษุสัตว์ Pawmely สาขาทองหล่อ ดูแลโรคต้อกระจก ตาแห้ง และต้อหินในสัตว์เลี้ยง' },
  ...
  },
  {
    ...
    experienceYears: 5,
    experiences: [
      { years: '2023-2026', description: 'แพทย์ประจำคลินิกทันตกรรมสัตว์ Pawmely ดูแลขูดหินปูน ถอนฟัน และผ่าตัดเหงือก' },
...
export const mockGroomers: TeleVet[] = [
  {
    ...
    clinic: 'Pawmely Grooming สาขาสุขุมวิท',
    experienceYears: 6,
    experiences: [
      { years: '2022-2026', description: 'หัวหน้าทีมช่างกรูมมิ่ง Pawmely Grooming ตัดขนสุนัขทุกพันธุ์ และอาบสปาแบบ Premium' },
  ...
  },
  {
    ...
    clinic: 'Pawmely Grooming สาขาทองหล่อ',
    experienceYears: 8,
    experiences: [
  ...
  },
  {
    ...
    clinic: 'Pawmely Grooming สาขาอารีย์',
    experienceYears: 5,
    experiences: [
...
export const mockBoardingClinics: TeleVet[] = [
  ...
  {
    id: 'bd4',
    name: 'Pawmely Pet Boarding ทองหล่อ',
