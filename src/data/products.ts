...
export const mockProducts: Product[] = [
  ...
  },
  {
    ...
    category: 'food',
    emoji: '🐶',
    imageUrl: img('1601758125946-6ec2ef64daf8'),
    name: 'Puppy Starter Mousse',
    brand: 'Royal Canin',
    description: 'อาหารเปียกสูตรลูกสุนัข อายุ 3 สัปดาห์ – 2 เดือน ย่อยง่าย',
    priceBaht: 120,
    rating: 4.8,
    reviewCount: 98,
    subscriptionEligible: true,
  ...
  },
  {
    ...
    category: 'food',
    emoji: '🐱',
    imageUrl: img('1592194996308-7b43878e84a6'),
    name: 'Senior Cat 7+ Wet Food',
    brand: 'Hills',
    description: 'อาหารเปียกสำหรับแมวสูงวัย รสไก่ บำรุงไต ตับ และข้อต่อ',
    priceBaht: 65,
    rating: 4.6,
    reviewCount: 142,
    subscriptionEligible: true,
  ...
  },
  {
    ...
    brand: 'PureBites',
    description: 'ขนมแมวฟรีซดราย แซลมอนแท้ 100% ไม่มีสารกันบูด',
    priceBaht: 290,
    rating: 4.9,
    reviewCount: 387,
    subscriptionEligible: true,
  ...
  },
  {
    ...
    emoji: '🥕',
    imageUrl: img('1583337130417-3346a1be7dee'),
    name: 'Veggie Mix Bites',
    brand: 'Vitakraft',
    description: 'ขนมกระต่าย ผักรวม แครอท + บีท + ผักโขม วิตามินสูง',
    priceBaht: 150,
    rating: 4.5,
    reviewCount: 64,
    subscriptionEligible: false,
  ...
  },
  {
    ...
    category: 'toys',
    emoji: '🦮',
    imageUrl: img('1601758228041-f3b2795255f1'),
    name: 'Kong Classic Rubber Medium',
    brand: 'Kong',
    description: 'ของเล่นยางทนเคี้ยว ยัดขนมข้างในได้ ลดความเครียด',
    priceBaht: 490,
    rating: 4.9,
    reviewCount: 521,
    subscriptionEligible: false,
  ...
  },
  {
    ...
    name: 'Catnip Plush Mouse 3-Pack',
    brand: 'KONG',
    description: 'หนูตุ๊กตาใส่แคทนิป กระตุ้นการเล่น 3 ตัว/แพ็ค',
    priceBaht: 220,
    rating: 4.6,
    reviewCount: 178,
    subscriptionEligible: false,
  ...
  },
  {
    ...
    category: 'supplies',
    emoji: '🪨',
    imageUrl: img('1591946614720-90a587da4a36'),
    name: 'Tofu Cat Litter 6L',
    brand: 'Pidan',
    description: 'ทรายแมวเต้าหู้ ย่อยสลายได้ทางชีวภาพ จับก้อนดีเยี่ยม',
    priceBaht: 350,
    originalPriceBaht: 420,
    rating: 4.8,
    reviewCount: 263,
    subscriptionEligible: true,
    subscriptionDiscountPct: 10,
  ...
  },
  {
    ...
    name: 'Padded Harness + Leash Set',
    brand: 'Truelove',
    description: 'ชุดสายจูง + เสื้อรัดอกบุนวม กระจายแรงดึง ไม่บีบคอ',
    priceBaht: 690,
    rating: 4.7,
    reviewCount: 211,
    subscriptionEligible: false,
  ...
  },
  {
    ...
    category: 'health',
    emoji: '💉',
    imageUrl: img('1576091160399-112ba8d25d1f'),
    name: 'Drontal Plus Dewormer',
    brand: 'Bayer',
    description: 'ยาถ่ายพยาธิรวม สำหรับสุนัข ครอบคลุมพยาธิตัวกลม-ตัวตืด',
    priceBaht: 320,
    rating: 4.7,
    reviewCount: 156,
    subscriptionEligible: false,
  ...
  },
  {
    ...
    emoji: '👁️',
    imageUrl: img('1584308666744-24d5c474f2ae'),
    name: 'Eye Cleansing Wipes 100s',
    brand: 'Virbac',
    description: 'ผ้าเช็ดทำความสะอาดรอบตา ขจัดคราบน้ำตา ใช้ได้ทุกวัน',
    priceBaht: 280,
    rating: 4.6,
    reviewCount: 89,
    subscriptionEligible: true,
